...
def ventana_Formulario_TP(menu):
    ...
    button_Salir=customtkinter.CTkButton(master=ventana,command=lambda: retornar_Menu(ventana, menu),text="Atras",corner_radius=10, font=("Arial",16),fg_color="#cc1919")
    button_Salir.grid(column=0, row=3)
